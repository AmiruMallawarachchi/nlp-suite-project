      ...
      <div className="flex flex-wrap items-center justify-center gap-3 py-2 px-2 bg-[#0a0a0a] border border-[#222] rounded-2xl max-w-2xl mx-auto shadow-2xl ring-1 ring-white/5">
        {tools.map((ToolItem) => (
          <button
            ...
            className={`flex items-center gap-2.5 px-5 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider transition-all duration-300 ${activeTab === ToolItem.id
              ...
              <div className="flex flex-wrap gap-2">
                {DEFAULT_LABELS.map((label) => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-full text-[11px] font-black uppercase tracking-widest transition-all ${labels.includes(label)
